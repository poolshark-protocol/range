...
export class DeployRangePool {
  ...
  public async runDeployment() {
    ...
    await this.initialSetup.readRangePoolSetup(hre.nonce)

    await this.initialSetup.createRangePool(hre.props.token0.address, hre.props.token1.address)
